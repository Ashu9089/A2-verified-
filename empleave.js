(function () {
  ...
  function friendlyError(error) {
    ...
    if (msg.includes('PREVIOUS_DATE_NOT_ALLOWED')) {
      return 'Previous date par leave apply nahi kar sakte.';
    }
  ...
  function renderHandovers() {
    ...
    handoverList.innerHTML = state.handovers.map(function (l) {
      return '<div class="history-item">' +
        '<div class="history-top"><div><strong>👤 ' + esc(l.employee_full_name || l.full_name || l.employee_name || '-') + '</strong> (' + esc(l.employee_code || l.emp_code || '-') + ')</div>' +
